...
var TestCompounds = []struct {
...
}{
	{
		compound: Compound{
			...
			Volume: Volume{value: decimal.NewFromInt(1), unit: liter, prefix: none},
			},
	...
	},
	{
		compound: Compound{
			...
			Volume: Volume{value: decimal.NewFromInt(500), unit: liter, prefix: none}},
	...
	},
	{
		...
		Mass: Mass{value: decimal.NewFromFloat(18.015)},
		Volume: Volume{value: decimal.NewFromFloat(1), unit: liter, prefix: micro},},
	...
	},
	{
		...
		Volume: Volume{value: decimal.NewFromFloat(2.50), unit: liter, prefix: none}},
	...
	},
	{
		compound: Compound{
			...
			Mass: Mass{value: decimal.NewFromFloat(18.015)},
			Volume: Volume{value: decimal.NewFromInt(1), unit: liter, prefix: micro}},
			molarity: decimal.NewFromInt(1),
